...
For convenience and reproducibility, the three CSV files (X, T, and Y) have been merged into a single tab-separated .txt file containing all covariates, treatment variables (birth weights), and outcome variables in one unified dataset.